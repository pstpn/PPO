...
func (_m *MockDocumentStorage) Create(ctx context.Context, request *dto.CreateDocumentRequest) error {
...
func (_m *MockDocumentStorage) Delete(ctx context.Context, request *dto.DeleteDocumentRequest) error {
	ret := _m.Called(ctx, request)
...
func (_m *MockDocumentStorage) GetByID(ctx context.Context, request *dto.GetDocumentRequest) (*model.Document, error) {
	ret := _m.Called(ctx, request)
...
func (_m *MockDocumentStorage) List(ctx context.Context, request *dto.ListEmployeeDocumentsRequest) ([]*model.Document, error) {
	ret := _m.Called(ctx, request)
...
type mockConstructorTestingTNewMockDocumentStorage interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockDocumentStorage(t mockConstructorTestingTNewMockDocumentStorage) *MockDocumentStorage {
