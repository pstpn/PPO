...
func (_m *EmployeeStorage) ListAll(ctx context.Context, request *dto.ListAllEmployeesRequest) ([]*model.Employee, error) {
	ret := _m.Called(ctx, request)
...
func (_m *EmployeeStorage) Validate(ctx context.Context, request *dto.LoginEmployeeRequest) error {
	ret := _m.Called(ctx, request)
...
type mockConstructorTestingTNewEmployeeStorage interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewEmployeeStorage(t mockConstructorTestingTNewEmployeeStorage) *EmployeeStorage {
