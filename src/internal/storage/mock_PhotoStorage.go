...
// MockPhotoStorage is an autogenerated mock type for the PhotoStorage type
type MockPhotoStorage struct {
	mock.Mock
}

// Delete provides a mock function with given fields: ctx, key
func (_m *MockPhotoStorage) Delete(ctx context.Context, key *model.PhotoKey) error {
...
func (_m *MockPhotoStorage) DeleteKey(ctx context.Context, request *dto.DeletePhotoRequest) error {
...
func (_m *MockPhotoStorage) Get(ctx context.Context, key *model.PhotoKey) ([]byte, error) {
	ret := _m.Called(ctx, key)
...
func (_m *MockPhotoStorage) GetKey(ctx context.Context, request *dto.GetPhotoRequest) (*model.PhotoMeta, error) {
	ret := _m.Called(ctx, request)
...
func (_m *MockPhotoStorage) Save(ctx context.Context, data []byte) (*model.PhotoKey, error) {
...
func (_m *MockPhotoStorage) Update(ctx context.Context, key *model.PhotoKey, data []byte) error {
...
type mockConstructorTestingTNewMockPhotoStorage interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockPhotoStorage creates a new instance of MockPhotoStorage. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockPhotoStorage(t mockConstructorTestingTNewMockPhotoStorage) *MockPhotoStorage {
	mock := &MockPhotoStorage{}
	mock.Mock.Test(t)
